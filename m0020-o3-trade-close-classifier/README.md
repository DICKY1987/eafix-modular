# Trade Close Classifier (O3_TRADE_CLOSE_CLASSIFIER)
...
**Module ID:** `50000000000000000020` &nbsp;|&nbsp; **Kind:** `OMS_MODULE` &nbsp;|&nbsp; **Domain:** Order Management (G5) &nbsp;|&nbsp; **Layer:** 4

## Purpose

Owns process step 20: Classify trade close and compute canonical PnL.

## Process binding

Owns process step **S20: Classify trade close and compute canonical PnL** (step 20 of `HUEY_P_EAFIX_END_TO_END`, phase PHASE_I -- OMS -> TRADE CLOSE -> REENTRY DECISION).
...
**Consumes:** TradeClosedRaw, ResolvedConfig
**Produces:** TradeClosed

## Dependencies

- `F1_CONFIG_PREFERENCES` (consumes_output, declared_output_contract_only)
- `O2_OMS_STATE_MACHINE` (consumes_output, declared_output_contract_only)

## File ownership

- `module_root`: `m0020-o3-trade-close-classifier`
