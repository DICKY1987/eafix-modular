# Agent instructions -- Event Log (F2_EVENT_LOG)
...
- Primary module root: `m0005-f2-event-log`
- If `module_root` is this module's own scaffold folder (not yet a real service directory), this module's canonical
  ...
  (`m0005-f2-event-log-src/`, `m0005-f2-event-log-tests/`, etc.) already contain the real implementation -- check `file_ownership.owned_files`
  in `manifest.json` first.

## Validation

- Applicable gates: GATE-F2_EVENT_LOG
- Applicable rules: VAL-S05-001
