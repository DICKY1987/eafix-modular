# Agent instructions -- Intent Builder (S2_INTENT_BUILDER)
...
- Primary module root: `m0012-s2-intent-builder`
- If `module_root` is this module's own scaffold folder (not yet a real service directory), this module's canonical
  ...
  (`m0012-s2-intent-builder-src/`, `m0012-s2-intent-builder-tests/`, etc.) already contain the real implementation -- check `file_ownership.owned_files`
  in `manifest.json` first.

## Validation

- Applicable gates: GATE-S2_INTENT_BUILDER
- Applicable rules: VAL-S12-001
