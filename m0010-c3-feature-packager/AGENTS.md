# Agent instructions -- Feature Packager (C3_FEATURE_PACKAGER)
...
- Primary module root: `m0010-c3-feature-packager`
- If `module_root` is this module's own scaffold folder (not yet a real service directory), this module's canonical
  ...
  (`m0010-c3-feature-packager-src/`, `m0010-c3-feature-packager-tests/`, etc.) already contain the real implementation -- check `file_ownership.owned_files`
  in `manifest.json` first.

## Validation

- Applicable gates: GATE-C3_FEATURE_PACKAGER
- Applicable rules: VAL-S10-001
