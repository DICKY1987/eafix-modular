...
class TelemetryDaemonPlugin(BasePlugin):
    ...
    def __init__(self):
        ...
        self._metrics = {
            "events": Counter("eafix_events_total", "Total events processed", ["event_type", "source"]),
            "event_latency": Histogram("eafix_event_latency_seconds", "Event processing latency"),
            "plugin_health": Gauge("eafix_plugin_health", "Plugin health status", ["plugin"])
        }
