# Calendar Normalizer (D3_CALENDAR_NORMALIZER)
...
**Module ID:** `50000000000000000004` &nbsp;|&nbsp; **Kind:** `INTEGRATION_BRIDGE_MODULE` &nbsp;|&nbsp; **Domain:** Data Ingest (G1) &nbsp;|&nbsp; **Layer:** 2

## Purpose

Owns process step 4: Normalize raw calendar entries.

## Process binding

Owns process step **S04: Normalize raw calendar entries** (step 4 of `HUEY_P_EAFIX_END_TO_END`, phase PHASE_B -- ECONOMIC CALENDAR INTAKE -> TRIGGERS).
...
**Consumes:** CalendarRaw, ResolvedConfig
**Produces:** CalendarEvent

## Dependencies

- `F1_CONFIG_PREFERENCES` (consumes_output, declared_output_contract_only)
- `D2_CALENDAR_SOURCE_ADAPTER` (consumes_output, declared_output_contract_only)

## File ownership

- `module_root`: `m0004-d3-calendar-normalizer`
