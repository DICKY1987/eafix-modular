# Agent instructions -- Calendar Normalizer (D3_CALENDAR_NORMALIZER)
...
- Primary module root: `m0004-d3-calendar-normalizer`
- If `module_root` is this module's own scaffold folder (not yet a real service directory), this module's canonical
  ...
  (`m0004-d3-calendar-normalizer-src/`, `m0004-d3-calendar-normalizer-tests/`, etc.) already contain the real implementation -- check `file_ownership.owned_files`
  in `manifest.json` first.

## Validation

- Applicable gates: GATE-D3_CALENDAR_NORMALIZER
- Applicable rules: VAL-S04-001
