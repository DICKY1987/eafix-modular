# Agent instructions -- Order Router (O1_ORDER_ROUTER)
...
- Primary module root: `m0015-o1-order-router`
- If `module_root` is this module's own scaffold folder (not yet a real service directory), this module's canonical
  ...
  (`m0015-o1-order-router-src/`, `m0015-o1-order-router-tests/`, etc.) already contain the real implementation -- check `file_ownership.owned_files`
  in `manifest.json` first.

## Validation

- Applicable gates: GATE-O1_ORDER_ROUTER
- Applicable rules: VAL-S15-001
