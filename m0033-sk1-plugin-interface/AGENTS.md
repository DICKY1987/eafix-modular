# Agent instructions -- Plugin Interface (SK1_PLUGIN_INTERFACE)
...
- Primary module root: `m0033-sk1-plugin-interface`
- If `module_root` is this module's own scaffold folder (not yet a real service directory), this module's canonical
  ...
  (`m0033-sk1-plugin-interface-src/`, `m0033-sk1-plugin-interface-tests/`, etc.) already contain the real implementation -- check `file_ownership.owned_files`
  in `manifest.json` first.

## Validation

- Applicable gates: GATE-SK1_PLUGIN_INTERFACE
- Applicable rules: VAL-SK1_PLUGIN_INTERFACE-NEEDS_REVIEW
