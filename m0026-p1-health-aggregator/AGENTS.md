...
- Primary module root: `services/flow-monitor`
- If `module_root` is this module's own scaffold folder (not yet a real service directory), this module's canonical
  ...
  (`m0026-p1-health-aggregator-src/`, `m0026-p1-health-aggregator-tests/`, etc.) already contain the real implementation -- check `file_ownership.owned_files`
