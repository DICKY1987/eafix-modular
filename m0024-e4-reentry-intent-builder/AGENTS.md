# Agent instructions -- Reentry Intent Builder (E4_REENTRY_INTENT_BUILDER)
...
- Primary module root: `m0024-e4-reentry-intent-builder`
- If `module_root` is this module's own scaffold folder (not yet a real service directory), this module's canonical
  ...
  (`m0024-e4-reentry-intent-builder-src/`, `m0024-e4-reentry-intent-builder-tests/`, etc.) already contain the real implementation -- check `file_ownership.owned_files`
  in `manifest.json` first.

## Validation

- Applicable gates: GATE-E4_REENTRY_INTENT_BUILDER
- Applicable rules: VAL-S24-001
