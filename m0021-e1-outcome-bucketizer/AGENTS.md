# Agent instructions -- Outcome Bucketizer (E1_OUTCOME_BUCKETIZER)
...
- Primary module root: `m0021-e1-outcome-bucketizer`
- If `module_root` is this module's own scaffold folder (not yet a real service directory), this module's canonical
  ...
  (`m0021-e1-outcome-bucketizer-src/`, `m0021-e1-outcome-bucketizer-tests/`, etc.) already contain the real implementation -- check `file_ownership.owned_files`
  in `manifest.json` first.

## Validation

- Applicable gates: GATE-E1_OUTCOME_BUCKETIZER
- Applicable rules: VAL-S21-001
