# Agent instructions -- Reporter (P2_REPORTER)
...
- Primary module root: `services/reporter`
- If `module_root` is this module's own scaffold folder (not yet a real service directory), this module's canonical
  ...
  (`m0032-p2-reporter-src/`, `m0032-p2-reporter-tests/`, etc.) already contain the real implementation -- check `file_ownership.owned_files`
  in `manifest.json` first.

## Validation

- Applicable gates: GATE-P2_REPORTER
- Applicable rules: VAL-P2_REPORTER-NEEDS_REVIEW
