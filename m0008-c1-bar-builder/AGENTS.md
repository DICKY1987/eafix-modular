# Agent instructions -- Bar Builder (C1_BAR_BUILDER)
...
- Primary module root: `m0008-c1-bar-builder`
- If `module_root` is this module's own scaffold folder (not yet a real service directory), this module's canonical
  ...
  (`m0008-c1-bar-builder-src/`, `m0008-c1-bar-builder-tests/`, etc.) already contain the real implementation -- check `file_ownership.owned_files`
  in `manifest.json` first.

## Validation

- Applicable gates: GATE-C1_BAR_BUILDER
- Applicable rules: VAL-S08-001
