# Agent instructions -- MT4 Adapter Transport (B1_MT4_ADAPTER_TRANSPORT)
...
- Primary module root: `m0016-b1-mt4-adapter-transport`
- If `module_root` is this module's own scaffold folder (not yet a real service directory), this module's canonical
  ...
  (`m0016-b1-mt4-adapter-transport-src/`, `m0016-b1-mt4-adapter-transport-tests/`, etc.) already contain the real implementation -- check `file_ownership.owned_files`
  in `manifest.json` first.

## Validation

- Applicable gates: GATE-B1_MT4_ADAPTER_TRANSPORT
- Applicable rules: VAL-S16-001
